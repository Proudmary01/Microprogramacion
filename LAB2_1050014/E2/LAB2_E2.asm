...
programa:               ; Etiqueta para el inicio del programa
        ...
        Mov AL,2dh      ; Se asigna el valor a la parte baja del registro AX. SE CAMBIO PARA MOSTRAR EL CARACTER Z.
        Mov BL,2dh      ; Se asigna el valor a la parte baja del registro BX. SE CAMBIO PARA MOSTRAR EL CARACTER Z.
